...
class ContactRepositoryLocalCSV : ContactRepository {
    ...
    override suspend fun getContactList(parameter: ContactsDto.Parameter.Get): Result<List<ContactData>, ApiError.ContactsError> {
        return try {
    ...
    override suspend fun sendContactList(parameter: ContactsDto.Parameter.Send): Result<Unit, ApiError.ContactsError> {
